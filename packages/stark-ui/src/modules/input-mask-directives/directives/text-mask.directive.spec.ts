...
describe("TextMaskDirective", () => {
	...
	describe("with ngModel", () => {
		...
		it.skip("should refresh the mask whenever the configuration changes", () => {
			changeInputValue(inputElement, "123");
			fixture.detectChanges();
		...
		it.skip("should show/hide the mask placeholders depending of the value of the 'guide' option", () => {
			changeInputValue(inputElement, "123");
			fixture.detectChanges();
