...
2. Continue `.9.4` through `.9.8` local tarball workflow work without bypassing dependency guards.
...
4. Synchronize WIP branches only after a separate exact-hash approval; later upstream changes use pull requests.
